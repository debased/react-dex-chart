...
var ChartHeader = function (_a) {
    var marketInfo = _a.marketInfo, interval = _a.interval, intervals = _a.intervals, setInterval = _a.setInterval, settings = _a.settings, updateSetting = _a.updateSetting, reset = _a.reset;
    return (react_1.default.createElement(ChartHeaderContainer, null,
        react_1.default.createElement(ChartHeaderItems, null,
            react_1.default.createElement(ChartHeaderContainer, null,
                react_1.default.createElement(exports.ChartHeaderItem, null,
                    react_1.default.createElement("img", { alt: "", src: (marketInfo === null || marketInfo === void 0 ? void 0 : marketInfo.image) ? marketInfo.image : '' }),
            ...
            react_1.default.createElement(ChartHeaderContainer, null,
                react_1.default.createElement(ChartSettings_1.default, { settings: settings, updateSetting: updateSetting, reset: reset })))));
};
