...
var TimezoneSettings = function (_a) {
    ...
    return (react_1.default.createElement(Items, null,
        react_1.default.createElement(Item, null,
            react_1.default.createElement("input", { type: "check", color: "primary", onClick: function () { return updateSetting({ timezone: { showSessions: !settings.timezone.showSessions } }); }, checked: settings.timezone.showSessions }),
            "Show sessions"),
        react_1.default.createElement(Item, null,
            react_1.default.createElement("input", { type: "check", color: "primary", defaultChecked: true }),
            "Timezone"),
        react_1.default.createElement(Item, null,
            react_1.default.createElement(ResetButton, null, "Defaults"))));
};
