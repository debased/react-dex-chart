    ...
    return (react_1.default.createElement(Items, null,
        react_1.default.createElement(Items, null,
            react_1.default.createElement(Item, null,
                react_1.default.createElement("input", { type: "checkbox", color: "primary", onClick: function () { return updateSetting({ section: 'background', type: 'gradient', value: !settings.background.gradient }); }, checked: settings.background.gradient }),
                "Background gradient"),
            react_1.default.createElement(Items, null,
                react_1.default.createElement(Item, null,
        ...
        react_1.default.createElement(Item, null,
            react_1.default.createElement(Items, null,
                react_1.default.createElement(Item, null,
                    react_1.default.createElement("input", { type: "checkbox", color: "primary", defaultChecked: true }),
                    "Show Watermark"),
                react_1.default.createElement(Item, null,
                    react_1.default.createElement(Input, { type: "text", defaultValue: "{pair} - ZigZag ({interval})" })))),
        react_1.default.createElement(Item, null,
