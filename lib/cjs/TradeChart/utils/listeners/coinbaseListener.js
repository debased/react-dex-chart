...
exports.coinbaseListener = void 0;
var adaptors_1 = require("../adaptors");
//import { getCoinbaseProduct } from "../helpers";
var coinbaseListener = function (ws, //websocket instance
fnc, //callback
dependencies //dependencies [product_ids: ['BTC-USD']]
    ...
    ws.onmessage = function (e) { return __awaiter(void 0, void 0, void 0, function () {
        var transformedData, candle;
        return __generator(this, function (_a) {
            transformedData = JSON.parse(e.data);
            //console.log("WS msg", transformedData);
            if (!transformedData.price)
                return [2 /*return*/];
            if (!transformedData.size)
                return [2 /*return*/];
            candle = (0, adaptors_1.coinbaseSocketAdaptor)(transformedData);
...
exports.coinbaseListener = coinbaseListener;
