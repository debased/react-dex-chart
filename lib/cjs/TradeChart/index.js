...
var TradeChart = function (props) {
    ...
    var _a = (0, react_1.useState)([]), updateData = _a[0], _ = _a[1];
    //legend OHLC
    var _b = (0, react_1.useState)(undefined), selectedLegendCandle = _b[0], setLegendCandle = _b[1];
    var _c = (0, react_1.useState)(undefined), priorLegendCandle = _c[0], setPriorLegendCandle = _c[1];
    var legends = {
        items: [{
