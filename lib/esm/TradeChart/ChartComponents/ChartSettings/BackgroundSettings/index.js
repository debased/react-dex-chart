    ...
    return (React.createElement(Items, null,
        React.createElement(Items, null,
            React.createElement(Item, null,
                React.createElement("input", { type: "checkbox", color: "primary", onClick: function () { return updateSetting({ section: 'background', type: 'gradient', value: !settings.background.gradient }); }, defaultChecked: settings.background.gradient }),
                "Background gradient"),
            React.createElement(Items, null,
                React.createElement(Item, null,
        ...
        React.createElement(Item, null,
            React.createElement(Items, null,
                "V1",
                React.createElement(Item, null,
                    React.createElement("input", { type: "checkbox", color: "primary", onClick: function () { return updateSetting({ section: 'background', type: 'watermark', value: !settings.background.watermark }); }, defaultChecked: settings.background.watermark }),
                    "Show Watermark"),
                React.createElement(Item, null,
