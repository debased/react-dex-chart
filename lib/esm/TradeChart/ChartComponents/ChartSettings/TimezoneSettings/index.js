...
var TimezoneSettings = function (_a) {
    ...
    return (React.createElement(Items, null,
        React.createElement(Item, null,
            React.createElement("input", { type: "checkbox", color: "primary", onClick: function () { return updateSetting({ section: 'timezone', type: 'showSessions', value: !settings.timezone.showSessions }); }, checked: settings.timezone.showSessions }),
            "Show sessions"),
        React.createElement(Item, null,
            React.createElement("input", { type: "check", color: "primary", defaultChecked: true }),
            "Timezone"),
        React.createElement(Item, null,
            React.createElement(ResetButton, { onClick: function () { return reset('timezone'); } }, "Defaults"))));
};
