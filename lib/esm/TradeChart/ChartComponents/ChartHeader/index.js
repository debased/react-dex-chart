    ...
    return (React.createElement(ChartHeaderContainer, null,
        React.createElement(ChartHeaderItems, null,
            React.createElement(ChartHeaderContainer, null,
                React.createElement(ChartHeaderItem, null,
                    React.createElement("img", { alt: "", src: (marketInfo === null || marketInfo === void 0 ? void 0 : marketInfo.image) ? marketInfo.image : '' }),
            ...
            React.createElement(ChartHeaderContainer, null,
                React.createElement(Settings, { settings: settings, updateSetting: updateSetting, reset: reset })))));
};
