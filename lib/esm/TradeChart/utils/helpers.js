...
export var formatCoinbaseInterval = function (interval) {
...
export var formatCoinexInterval = function (interval) {
    switch (interval.toLowerCase()) {
        case '1m':
            return "1min";
        case '5m':
...
export var getCoinbaseProduct = function (pair) { return __awaiter(void 0, void 0, void 0, function () {
    var response, stats;
