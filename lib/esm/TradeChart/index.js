...
export var TradeChart = function (props) {
    ...
    var _a = useState([]), candleData = _a[0], setData = _a[1];
    var _b = useState([]), updateData = _b[0], setUpdateData = _b[1];
    //legend OHLC
    var _c = useState(undefined), selectedLegendCandle = _c[0], setLegendCandle = _c[1];
    var _d = useState(undefined), priorLegendCandle = _d[0], setPriorLegendCandle = _d[1];
    var legends = {
        items: [{
    ...
    var fetchCandleData = useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetcher(pair, props.interval, props.marketInfo.exchange, function (value) {
                        console.error("error: ", value);
                    })];
                case 1:
                    transformedData = _a.sent();
                    formattedData = candleStickFormatter(transformedData, props.marketInfo.exchange);
    ...
    return (React.createElement(ThemeProvider, { theme: chartLayout },
        React.createElement(ChartContainer, null,
            React.createElement(ErrorBoundary, null,
                ...
                React.createElement(ChartView, { initialChartData: candleData, updateData: updateData, orders: props.userOrders, userFills: props.userFills, marketAlias: pair, legends: legends, chartLayout: chartLayout, candleStickConfig: {
                        priceFormat: {
                            type: 'price',
